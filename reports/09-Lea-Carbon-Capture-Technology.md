## Policy Debate: Government-Subsidizing of Carbon Capture Technology

Should governments around the world subsidize the production of carbon-capture technology – what some believe to be a crucial element in mitigating climate change – or (based on evidence about said technology) should climate-mitigation government funds be directed elsewhere?

**Main category**: Environment and Natural Resources

https://www.nytimes.com/interactive/2016/07/01/science/what-is-clean-coal.html?searchResultPosition=7
...
https://www.nytimes.com/2019/04/07/business/energy-environment/climate-change-carbon-engineering.html?searchResultPosition=15
https://www.nytimes.com/2016/05/06/science/exxon-mobil-backs-fuelcell-effort-to-advance-carbon-capture-technology.html?searchResultPosition=1

## Main groups  

### Supporting group
Name: Environmental Groups, such as *Center for Climate and Energy Solutions*, *Clean Air Task Force*, and some business groups, like *Boston Consulting Group*, *US Congress, in form of the "FUTURE ACT", led by Heitkamp, Capito, Whitehouse, Barrasso, and others*, *Great Plains Institute*, *Western Governors Association, Southern States Energy Board, and National Association of Regulatory Utility Commissioner*, Fossil Fuel companies such as ExxonMobile, Shell, Chevron, and others.
...
- https://www.climatedocket.com/2019/03/13/carbon-capture-fossil-fuels-ciel-report/
    ...
    - Oil companies get tax breaks when they invest in fossil fuel storage, likely benefit and profit financially due to investments in capture-tech stationed at their current stations, let alone the potential revenue from Enhanced Oil Recovery propped up by CCS.
...
### Opposing group
Name: Other environmental groups, such as *Greenpeace*,*Sunrise Movement*, *National Resources Defense Council*, *Center for International Environmental Law (published paper warning of possible slow-down of transition to renewables)*, some members of congress, such as Vermont Senator Bernie Sanders.
...
### Main Benefits
###### - potential for capturing and storing 2,000 gigatons of carbon dioxide by 2050.
...
- found in IPCC report in Section 2.4 "Disentangling the Whole System Transformation" --> under subsection 2.4.2.3 "Deployment of carbon capture and storage," found here: https://www.ipcc.ch/sr15/chapter/chapter-2/


### Main Costs
##### Overall:
- Drawbacks are not actually presented by those supporting the production of these technologies, but potential risks and costs are discussed in the IPCC report at length
- Though well-funded and "hot" in the market for sustainable development, these methods are not proven effective on a massive scale;
-   
###### If poorly implemented, carbon dioxide removal (CDR) options such as bioenergy, BECCS and AFOLU would lead to trade- offs. Appropriate design and implementation requires considering local people’s needs, biodiversity and other sustainable development dimensions (very high confidence). {5.4.1.3, Cross-Chapter Box 7 in Chapter 3}"
- "The impacts of carbon dioxide removal options on SDGs depend on the type of options and the scale of deployment (high confidence).

-  5.4.1.1: "However, possible trade-offs due to risks of CCS-based carbon leakage, increased electricity demands, and associated price impacts affecting energy access and poverty (SDGs 7 and 1) would need careful regulatory attention (Wesseling et al., 2017)"
- "The use of fossil CCS, which plays an important role in deep mitigation pathways (see Chapter 2, Section 2.4.2.3), implies continued adverse impacts of upstream supply-chain activities in the coal sector, and because of lower efficiency of CCS coal power plants (SDG 12), upstream impacts and local air pollution are likely to be exacerbated (SDG 3). Furthermore, there is a non-negligible risk of carbon dioxide leakage from geological storage and the carbon dioxide transport infrastructure (SDG 3) (Table 5.2)."
  - Emerging evidence indicates that future mitigation efforts that would be required to reach stringent climate targets, particularly those associated with carbon dioxide removal (CDR) (e.g., afforestation and reforestation and bioenergy with carbon capture and storage; BECCS), may also impose significant constraints upon poor and vulnerable communities (SDG 1) via increased food prices and competition for arable land, land appropriation and dispossession (Cavanagh and Benjaminsen, 2014; Hunsberger et al., 2014; Work, 2015; Muratori et al., 2016; Smith et al., 2016; Burns and Nicholson, 2017; Corbera et al., 2017)222 with disproportionate negative impacts upon rural poor and indigenous populations (SDG 1) (robust evidence, high agreement) (Section 5.4.2.2, Table 5.2, Figure 5.2) (Grubert et al., 2014; Grill et al., 2015; Zhang and Chen, 2015; Fricko et al., 2016; Johansson et al., 2016; Aha and Ayitey, 2017; De Stefano et al., 2017; Shi et al., 2017)223. Crops for bioenergy may increase irrigation needs and exacerbate water stress with negative associated impacts on SDGs 6 and 10 (Boysen et al., 2017)224.
